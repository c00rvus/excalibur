...
[Download Excalibur v0.4.11](https://github.com/c00rvus/excalibur/releases/tag/v0.4.11)

Common installers:

- [Windows setup `.exe`](https://github.com/c00rvus/excalibur/releases/download/v0.4.11/Excalibur_0.4.11_x64-setup.exe)
- [Windows `.msi`](https://github.com/c00rvus/excalibur/releases/download/v0.4.11/Excalibur_0.4.11_x64_en-US.msi)
- [macOS universal `.dmg`](https://github.com/c00rvus/excalibur/releases/download/v0.4.11/Excalibur_0.4.11_universal.dmg)
- [Linux AppImage](https://github.com/c00rvus/excalibur/releases/download/v0.4.11/Excalibur_0.4.11_amd64.AppImage)
